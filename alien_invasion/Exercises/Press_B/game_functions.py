...
def check_keydown_events(screen, ai_settings, event, ship, bullets, stats):
...
def check_events(screen, ai_settings, ship, bullets, play_button, stats):
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            check_keydown_events(screen, ai_settings, event, ship, bullets, stats)
...
def update_aliens(screen, ai_settings, aliens, bullets, ship, stats):
    ...
    check_fleet_bottoms(screen, ai_settings, aliens, bullets, ship, stats)
...
def update_screen(screen, ai_settings, ship, aliens, bullets, stats, play_button):
...
def check_fleet_bottoms(screen, ai_settings, aliens, bullets, ship, stats):
    for alien in aliens.sprites():
