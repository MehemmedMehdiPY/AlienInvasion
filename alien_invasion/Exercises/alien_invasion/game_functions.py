...
def check_events(screen, ai_settings, stats, play_button, ship, bullets):
...
def update_aliens(screen, ai_settings, aliens, bullets, stats, ship):
    check_fleet_edges(aliens, ai_settings)
    aliens.update()
    
    check_alien_ship_collisions(screen, ai_settings, aliens, bullets, stats, ship)
...
def ship_hit(screen, ai_settings, aliens, bullets, stats, ship):

    if ai_settings.non_collided_ships > 0:
        ai_settings.non_collided_ships -= 1
        aliens.empty()
        bullets.empty()
...
def check_alien_ship_collisions(screen, ai_settings, aliens, bullets, stats, ship):
    if pygame.sprite.spritecollideany(ship, aliens):
        ship_hit(screen, ai_settings, aliens, bullets, stats, ship)
