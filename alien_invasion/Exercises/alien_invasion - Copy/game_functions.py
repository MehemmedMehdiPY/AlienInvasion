...
def update_aliens(screen, ai_settings, aliens, bullets, ship):
    check_fleet_edges(aliens, ai_settings)
    aliens.update()
    
    check_alien_ship_collisions(screen, ai_settings, aliens, bullets, ship)
...
def ship_hit(screen, ai_settings, aliens, bullets, ship):
...
def check_alien_ship_collisions(screen, ai_settings, aliens, bullets, ship):
    if pygame.sprite.spritecollideany(ship, aliens):
        ship_hit(screen, ai_settings, aliens, bullets, ship)